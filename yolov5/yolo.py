...
class YOLO(object):
    _defaults = {
        ...
        #---------------------------------------------------------------------#
        "anchors_path"      : os.path.join(runtime, 'yolov5/model_data/yolo_anchors.txt'),
    ...
    def detect_image(self, image, crop = False, count = False):
        ...
        #   设置字体与边框厚度
        #---------------------------------------------------------#
        font        = ImageFont.truetype(font=os.path.join(runtime, 'yolov5/model_data/simhei.ttf'), size=np.floor(3e-2 * image.size[1] + 0.5).astype('int32'))
